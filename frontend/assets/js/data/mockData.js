...
export const MOCK_CHAT_SESSIONS = [
    {
        id: 'conv-1', name: 'Nguyễn Thị A', type: 'auto', status: 'replied', lastMsg: 'Sắp có hàng Shopee Mall chưa shop?', time: '10:05', badge: 'Tự động',
        messages: [
    ...
    {
        id: 'conv-2', name: 'Trần Văn B', type: 'review', status: 'waiting', lastMsg: 'Mua 3 cái có bớt không?', time: '09:45', badge: 'Chờ duyệt',
        messages: [
    ...
    {
        id: 'conv-3', name: 'Lê C', type: 'escalate', status: 'action_needed', lastMsg: 'Làm ăn dối trá, hàng giả à?', time: '09:12', badge: 'Cần XL', flags: ['Toxic', 'Complain'],
        messages: [
